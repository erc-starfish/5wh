...
# Importing the data:
data_agreementadj <- read.delim("C:/Users/raque/OneDrive/Documents/PhD/Data_analysis_verbal_morphology/strong-adj-intersective5b.cod.ooo", header=F, sep=":")
...
# Importing the data:
data_agreementquant <- read.delim("C:/Users/raque/OneDrive/Documents/PhD/Data_analysis_verbal_morphology/quantifier-pl.cod.ooo", header=F, sep=":")
...
mapengland2<- ggplot() + 
  ...
  scale_color_viridis(option="turbo", limits=c(-1,1)) +
...
total$Dialect <- relevel(factor(total$Dialect), ref = 2)
ex.fittotal <- lm(diff~Dialect, data=total)
summary(ex.fittotal)
