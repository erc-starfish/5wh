...
pronoun_plot <- function(mydata, country, panelID, type="regular") {
  ...
  if (type == "supp") {
    ...
    barchart <- barchart + scale_fill_manual(values = c("OVERT" = "#3d62a6", "NULL" = "#e6e7f0")) + scale_color_manual(values = c("DOC" = "black", "LIT" = "black", "SUPP" = "black")) + theme(axis.text.x = element_text(size = 10, color = "black"), axis.text.y=element_text(color="black"))
    #supp genre ^^^
